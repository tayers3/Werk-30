...
export const exercises: Exercise[] = [
  ...
  // 🟣 STRETCHING (GYM)
  { id:"hamstring", name:"Hamstring Stretch", description:"Stretch hamstrings", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=v1VYq2H3h2o"},
  { id:"quad", name:"Quad Stretch", description:"Stretch quads", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=FvQ6Vx9g6pA"},
  { id:"calf", name:"Calf Stretch", description:"Stretch calves", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=YMmgqO8Jo-k"},
  { id:"shoulder", name:"Shoulder Stretch", description:"Upper stretch", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=6jHsraw2NIk"},
  { id:"cobra", name:"Cobra Stretch", description:"Lower back stretch", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=JDcdhTuycOI"},
  { id:"childpose", name:"Child's Pose", description:"Recovery stretch", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=eqVMAPM00DM"},
  { id:"hipflexor", name:"Hip Flexor Stretch", description:"Hip mobility", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=7bRaX6M2nr8"},
  { id:"spine", name:"Spinal Twist", description:"Back mobility", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=wkD8rjkodUI"},
  { id:"neck", name:"Neck Stretch", description:"Neck mobility", muscleGroup:"stretching", intensity:"low", duration:300, sets:2, reps:"30 sec", locations:["gym"], youtube:"https://www.youtube.com/watch?v=2NOsE-VPpkE"},
